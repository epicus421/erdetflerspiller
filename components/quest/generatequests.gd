...
func _ready():
	...
	var q12 = _create_quest_hverdagskomiker()
	_save_quest(q12, quests_dir + "quest_hverdagskomiker.tres")
...
func _create_quest_2() -> Quest:
	...
	quest.brief_description = "Snakk med bankansatt"
	quest.required_quest_ids.append("GRANDPA_REQUEST")

	var obj = QuestObjective.new()
	obj.objective_id = "talk_to_bank_teller"
	obj.description = "Løs inn dokumentet i banken"
	obj.type = QuestObjective.ObjectiveType.TALK_TO_NPC
	obj.target_id = "bank_teller"
	obj.target_amount = 1
	quest.objectives.append(obj)
...
func _create_quest_3() -> Quest:
	...
	obj.description = "Kjøp is i KJIWI"
...
func _create_quest_4() -> Quest:
	...
	obj.description = "Gå tilbake til bestefar"
	obj.type = QuestObjective.ObjectiveType.TALK_TO_NPC
	obj.target_id = "grandpa"
	obj.target_amount = 1
	quest.objectives.append(obj)
...
func _create_quest_5() -> Quest:
	...
	talk_obj.description = "Snakk med Chief Keef på Lånekassa"
	...
	minigame_obj.description = "Fyll ut stipendsøknaden"
...
func _create_quest_6() -> Quest:
	...
	var obj = QuestObjective.new()
	obj.objective_id = "talk_to_bank_teller_again"
	obj.description = "Ta ut stipendet i banken"
	obj.type = QuestObjective.ObjectiveType.TALK_TO_NPC
	obj.target_id = "bank_teller"
	obj.target_amount = 1
	quest.objectives.append(obj)
	...
	quest.unlock_quests.append("KRIS_LUA")
...
func _create_quest_7() -> Quest:
	...
	obj.description = "Kjøp den siste isen i KJIWI"
	obj.type = QuestObjective.ObjectiveType.PURCHASE_ITEM
	obj.target_id = "icecream"
	obj.target_amount = 1
	quest.objectives.append(obj)
...
func _create_quest_8() -> Quest:
	...
	obj.description = "Lever isen til bestefar"
	obj.type = QuestObjective.ObjectiveType.TALK_TO_NPC
	obj.target_id = "grandpa"
	obj.target_amount = 1
...
func _create_quest_kris_lua() -> Quest:
	...
	quest.description = "Snakk med Grusbrødrene"
	quest.brief_description = "Snakk med Grusbrødrene"
	quest.quest_type = Quest.QuestType.GATHER
	quest.required_quest_ids.append("BANK_DEPOSIT")

	var obj: = QuestObjective.new()
	obj.objective_id = "find_hat"
	obj.description = "Finn Kristoffers caps"
	...
	quest.offer_dialogue.append("En liten fugl fortalte meg at du har behov for litt penger.")
	quest.offer_dialogue.append("De forbanna steinene tok capsen min...")
	quest.offer_dialogue.append("Den uvurderlige Peak Performance-capsen min.")
	quest.offer_dialogue.append("Få tilbake capsen min, så lover jeg deg at du skal bli belønnet rikelig!")
	quest.offer_dialogue.append("Om ikke jeg tar feil, sitter de nok i garasjen sin inneklemt i et av Kratergatas mange ekle hjørner.")
	quest.completion_dialogue.append("Tusen takk for at du fant den!")
	return quest

func _create_quest_hverdagskomiker() -> Quest:
	var quest: = Quest.new()
	quest.quest_id = "HVERDAGSKOMIKER"
	quest.name = "Ingen strøm"
	quest.description = "Sjekk ut kraftverket"
	quest.brief_description = "Sjekk ut kraftverket"

	var talk_hk: = QuestObjective.new()
	talk_hk.objective_id = "talk_to_hverdagskomiker"
	talk_hk.description = "Snakk med Hverdagskomikeren ved kraftstasjonen"
	talk_hk.type = QuestObjective.ObjectiveType.TALK_TO_NPC
	talk_hk.target_id = "hverdagskomiker"
	talk_hk.target_amount = 1
	quest.objectives.append(talk_hk)

	var kobber: = QuestObjective.new()
	kobber.objective_id = "collect_kobber"
	kobber.description = "Snakk med ungen ved strømmasta"
	kobber.type = QuestObjective.ObjectiveType.GATHER_ITEM
	kobber.target_id = "kobber"
	kobber.target_amount = 1
	quest.objectives.append(kobber)

	var plast: = QuestObjective.new()
	plast.objective_id = "collect_plast"
	plast.description = "Fisk ved dammen bak kraftstasjonen"
	plast.type = QuestObjective.ObjectiveType.GATHER_ITEM
	plast.target_id = "plast"
	plast.target_amount = 1
	quest.objectives.append(plast)

	var gummi: = QuestObjective.new()
	gummi.objective_id = "collect_gummi"
	gummi.description = "Skyt et bildekk på Kratergata"
	gummi.type = QuestObjective.ObjectiveType.GATHER_ITEM
	gummi.target_id = "gummi"
	gummi.target_amount = 1
	quest.objectives.append(gummi)

	quest.reward_money = 0
	quest.offer_dialogue.append("Ja, hei. Sikringen blåste.")
	quest.offer_dialogue.append("Æ treng kobberledning, plast og gummi.")
	quest.offer_dialogue.append("Finn det sjøl.")
	quest.completion_dialogue.append("Godt jobba.")
	return quest

func _create_quest_iver() -> Quest:
	var quest: = Quest.new()
	quest.quest_id = "IVER_BEVIS"
	quest.name = "SLAKT I GRUSENS NAVN"
	...
	quest.offer_dialogue.append("Hvis du lover å ikke gi det til grusbrødrene, hvis du signerer denne kontrakten")
	quest.offer_dialogue.append("OG henter meg 3 kråkefjær og 1 elgskinn så skal jeg selge deg grus.")

	quest.completion_dialogue.append("Takk for fjær og skinn.")
	quest.completion_dialogue.append("Nå blir det suppe.")
	quest.completion_dialogue.append("Her har du grus som takk.")
	quest.completion_dialogue.append("Ikke gi det til Stein og Steinar.")
	quest.reward_money = 0
...
func _create_quest_steinar() -> Quest:
	...
	obj.description = "Lever grus til Stein og Steinar"
	...
	quest.completion_dialogue.append("Her har du capsen.")
	return quest
